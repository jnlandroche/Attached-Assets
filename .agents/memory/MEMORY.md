...
- [Vite BASE_PATH production build fix](vite-base-path-build.md) — Replit's build env doesn't inject [services.env] vars; BASE_PATH must default to '/' or every publish silently fails and serves stale dist/.
